...
export interface car extends groundTransport {
  brand: string
  vehiclePassport: "Оригинал" | "Дубликат" | "Электронный"
  inspectionData: ("Есть сервисная книжка" | "Обслуживался у дилера" | "На гарантии")[]
  color: "Белый" | "Серебрянный" | "Серый" | "Чёрный" | "Коричневый" | "Золотой" | "Бежевый" | "Красный" | "Бордовый" | "Оранжевый" | "Жёлтый" | "Зелёный" | "Голубой" | "Синий" | "Фиолетовый" | "Пурпурный" | "Розовый"
  additionalOptions: {
...
export interface carOld extends car {
  type: "Продаю личный автомобиль" | "Автомобиль приобретён на продажу"
